...
import { Play, ExternalLink, Zap, Copy, Check, Bolt, Layers, Server } from "lucide-react"
...
const endpoints: ApiEndpoint[] = [
  ...
  },
  {
    ...
    method: "POST",
    path: "/api/api/todos",
    description: "POST route with JSON body via c.BodyParser()",
    body: { title: "Learn Fiber Framework" },
  },
  {
    name: "Get Todo by ID",
    method: "GET",
    path: "/api/api/todos/1",
    description: "Dynamic route parameter with c.Params(\"id\")",
  },
  {
    name: "Toggle Todo",
    method: "PATCH",
...
func main() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="gradient-orb gradient-orb-primary w-[600px] h-[600px] -top-[200px] left-[20%] animate-pulse-glow" />
      <div className="gradient-orb gradient-orb-secondary w-[350px] h-[350px] top-[60%] -right-[80px] animate-pulse-glow animation-delay-200" />

      <header className="header-border relative z-10">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-end">
            <a href="https://github.com/TencentEdgeOne/go-fiber-template" target="_blank" rel="noopener noreferrer" className="icon-glow text-gray-400 hover:text-[#00ADD8] transition-colors p-2" aria-label="GitHub">
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-6 animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00ADD8] via-[#5DC9E2] to-white">Fiber</span>
              <span className="text-white/70"> + EdgeOne Pages</span>
            </h1>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Express-inspired web framework built on top of <code className="text-[#00ADD8] bg-[#00ADD8]/10 px-1.5 py-0.5 rounded">Fasthttp</code>, the fastest HTTP engine for Go. Build fast, run fast.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-100">
            <a href="https://edgeone.ai/pages/new?from=github&template=go-fiber-template" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-12">
            <div className="feature-card p-5 animate-fade-in-up animation-delay-100">
              <div className="w-10 h-10 mb-4 rounded-lg bg-[#00ADD8]/15 flex items-center justify-center"><Bolt className="w-5 h-5 text-[#00ADD8]" /></div>
              <h3 className="font-semibold mb-2">Blazing Fast</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Built on Fasthttp for maximum throughput and minimal latency</p>
            </div>
            <div className="feature-card p-5 animate-fade-in-up animation-delay-200">
              ...
              <h3 className="font-semibold mb-2">Express-like API</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Familiar Express.js-style syntax for easy migration</p>
            </div>
            <div className="feature-card p-5 animate-fade-in-up animation-delay-300">
              ...
              <h3 className="font-semibold mb-2">Built-in Middleware</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Rich ecosystem of built-in middleware for common tasks</p>
            </div>
          </div>
        </div>
      </main>
